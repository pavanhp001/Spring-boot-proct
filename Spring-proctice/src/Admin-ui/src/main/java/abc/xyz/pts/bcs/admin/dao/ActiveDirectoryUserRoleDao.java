...
public class ActiveDirectoryUserRoleDao extends UserRoleDao{
    ...
    public List<UserRoleData> findAllRoles() 
    {
        ...
        filter = new EqualsFilter(ActiveDirectoryLdapConstants.OBJECT_CLASS.getValue(), ActiveDirectoryLdapConstants.GROUP_OF_URLS.getValue());
    ...
    public UserRoleData findByRoleCode(final String roleCode) 
    {
        ...
        return (UserRoleData) ldapTemplate.searchForObject(roleAbsoluteBaseName, filter.encode(), roleAttributeMapper);
    }
