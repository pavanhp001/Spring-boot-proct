 ...
 * atomic unit of dialogue with the client.
 * 
 * @author rchapple
 * 
 */
...
public class DialogueBean implements CommonBeanInterface, Comparable<DialogueBean>
{

    /**
	 * 
	 */
	private static final long serialVersionUID = 7976608707746624397L;
     ...
     * @return the int
     */
    public int compareTo( final DialogueBean compare )
    {
