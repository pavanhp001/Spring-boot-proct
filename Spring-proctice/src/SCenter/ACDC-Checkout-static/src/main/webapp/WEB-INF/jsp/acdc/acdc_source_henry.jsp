...
<%-- 	<script src="<c:url value='/script/jquerytools-1.2.5.js'/>"></script>
	...
	<script src="<c:url value='/js/newcko/jquery-1.4.2.min.js'/>"></script>
    <script src="<c:url value='/js/newcko/jquery.form.js'/>"></script>
    <script src="<c:url value='/js/newcko/jquery.validate.js'/>"></script>
    <script src="<c:url value='/js/newcko/bbq.js'/>"></script>
    <script src="<c:url value='/js/newcko/jquery-ui-1.8.5.custom.min.js'/>"></script>
    <script src="<c:url value='/js/newcko/jquery.form.wizard.js'/>"></script>


<!-- CKO Css source files -->
	...
	<link rel="stylesheet" href="<c:url value='/style/jquery.ui.all.css'/>" />
	<link rel="stylesheet" href="<c:url value='/style/jquery.datepick.css'/>" />
	<title> AL Digital Static CKO</title>