...
public class CustomerInfoVOBuilder {
	...
	public static CustomerType buildCustomerType(CustomerInfoVO customerInfoVO, String customerExternalID, Customer orderCustomer) {
		...
		if(customerInfoVO.getEmailAddress() != null){
			...
			newCust.setBestEmailContact(customerInfoVO.getEmailAddress());
		}
		...
		newCust.setPhoneContactOptIn(customerInfoVO.isPhoneContactOptIn());
		newCust.setMarketingOptIn(customerInfoVO.isMarketingOptIn());
		newCust.setContractAccountNumber(customerInfoVO.getContractAccountNumber());
