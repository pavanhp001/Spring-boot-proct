...
public class Utils {
	...
	public static boolean isValidSession(SessionVO sessionVO, String CKOVOName) {
		if(sessionVO != null && sessionVO.get(CKOVOName) != null){
			logger.info("sessionVo get sessionId="+ sessionVO.getSessionId());
			logger.info("CKOVOName=" + CKOVOName);
	 ...
	 * @throws Exception
	 */
	public static String convertJSONString(Object obj) throws Exception{
		Gson gson = new Gson();
		try{
