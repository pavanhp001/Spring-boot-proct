...
public enum ProductServiceUI {
	...
	public ProductInfoType getProduct(String productExternalId, String GUID, String providerExternalId) {
		...
		/*
		 * commenting the product cache service as the features added in the data base are not getting effected
		 * so, this does a service call when ever this method is called
		 */
