...
<form action="<%=request.getContextPath()%>/static/CKO" method="post" target="CKOContent" onsubmit="symFeedbackSubmit()">
  ...
  <input type="text" name="CKOInput" id="CKOInput" value='{"CKO":{"orderId":18182,"customerId":999,"parentUrl":"http://localhost:8098/salescenter/CKO/23453","status":"CKOReady","lineItems":{"long":[18871]},"params":{"string":["shortForm=N","includeSubmit=N","cancelOnError=Y"]}}}' class="callButton" style="width:90%;" />
