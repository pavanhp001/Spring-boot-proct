...
public class Constants {
	...
	public static final String HOME_CONTACTNUMBER = "homePhoneNumber";
	...
	public static final String CELL_CONTACTNUMBER = "cellPhoneNumber";
	...
	public static final String OFFERTYPE_CLOSINGRENTERS = "OFFER_TYPE=CLOSINGRENTERS";
	public static final String CLOSING_RENTERS_PROVIDER_ID = "15499401";
	public static final String RECEIVER_MATCH = "RECEIVER_MATCH";
	public static final String CHARTER = "charter";
	public static final String SPECTRUM = "spectrum";
	public static final String ENERGY_RATE = "2000";
	public static final String UTILITYOFFER = "UtilityOffer";
	public static final String DOMINION_PROVIDER_ID = "10513134";
