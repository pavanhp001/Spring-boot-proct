...
public class OrderQualVO {
	...
	private String dominionProductExtIds;
	private String inumVal;
	
	public String getInumVal() {
		return inumVal;
	}

	public void setInumVal(String inumVal) {
		this.inumVal = inumVal;
	}

	public String getDominionProductExtIds() {
		return dominionProductExtIds;
	}

	public void setDominionProductExtIds(String dominionProductExtIds) {
		this.dominionProductExtIds = dominionProductExtIds;
	}
