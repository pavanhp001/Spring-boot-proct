...
public enum OrderServiceUI {
	...
	public OrderType updateLineItemAttributesBySelectedlineItem(OrderQualVO orderQualVO, long lineItemExternalID, 
			SalesContextType context, LineItemType lineItem, Map<String, String> requestParamMap){
		...
		LineItemAttributeType lineItemAttribute = oFactory.createLineItemAttributeType();
		lineItemAttribute.getEntity().add(CKOLineItemFactory.INSTANCE.setAttributeEntityType("WebOrderHeaderId", requestParamMap.get("WebOrderHeaderId"),"", "WEBORDER_HEADERID"));
		lineItemAttribute.getEntity().add(CKOLineItemFactory.INSTANCE.setAttributeEntityType("OrderProcessedAmt", requestParamMap.get("OrderProcessedAmt"),"", "ORDER_PROCESSED_AMT"));
		lineItemAttribute.getEntity().add(CKOLineItemFactory.INSTANCE.setAttributeEntityType("ProductOfferId", requestParamMap.get("ProductOfferId"),"", "PRODUCT_OFFERID"));
		lineItemAttribute.getEntity().add(CKOLineItemFactory.INSTANCE.setAttributeEntityType("STATUS", Constants.CKO_COMPLETE,"CKO Completed", "CKO"));
		lineItem.setLineItemAttributes(lineItemAttribute);
