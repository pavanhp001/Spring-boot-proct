...
public class BroadcastThread implements Runnable {
    ...
    private static final String BROADCAST_NAMESPACE = "ome/broadcast";
    ...
    public void run() {
	logger.info("Executing broadcast from thread = " + tName +", Broadcast ExtId = " + broadcastMessage.getId() +", Type=" + broadcastMessage.getTransactionType());
