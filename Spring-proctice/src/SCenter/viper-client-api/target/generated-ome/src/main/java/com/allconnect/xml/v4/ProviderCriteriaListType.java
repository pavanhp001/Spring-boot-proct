...
public class ProviderCriteriaListType {
    ...
    protected List<ProviderCriteriaListEntityType> provider;
     ...
     * 
     */
    public List<ProviderCriteriaListEntityType> getProvider() {
        if (provider == null) {
            provider = new ArrayList<ProviderCriteriaListEntityType>();
        }
