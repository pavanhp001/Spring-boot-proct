...
public class AcMessageType {
    ...
    @XmlElement(required = true)
    protected AcMessageType.Payload payload;
     ...
     * @return
     *     possible object is
     *     {@link AcMessageType.Payload }
     *     
     */
    public AcMessageType.Payload getPayload() {
        return payload;
    }
     ...
     *     
     */
    public void setPayload(AcMessageType.Payload value) {
        this.payload = value;
    }
