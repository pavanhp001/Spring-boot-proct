 ...
 *         &lt;element name="searchResult" type="{http://xml.A.com/v4}customerData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomerSearch {
    ...
    protected List<CustomerData> searchResult;
    ...
    public List<CustomerData> getSearchResult() {
        if (searchResult == null) {
            searchResult = new ArrayList<CustomerData>();
        }
