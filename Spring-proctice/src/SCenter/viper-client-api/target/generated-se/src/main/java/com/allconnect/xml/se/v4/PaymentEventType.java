...
public class PaymentEventType {
    ...
    protected List<PaymentStatusWithTypeType> paymentStatuses;
     ...
     * 
     */
    public List<PaymentStatusWithTypeType> getPaymentStatuses() {
        if (paymentStatuses == null) {
            paymentStatuses = new ArrayList<PaymentStatusWithTypeType>();
        }
