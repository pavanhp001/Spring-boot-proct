...
public class LineItemSelectionType {
    ...
    @XmlElement(name = "selectionChoice")
    protected List<SelectionChoiceType> selectionChoices;
    ...
    /**
     * Gets the value of the selectionChoices property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the selectionChoices property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSelectionChoices().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SelectionChoiceType> getSelectionChoices() {
        if (selectionChoices == null) {
            selectionChoices = new ArrayList<SelectionChoiceType>();
        }
