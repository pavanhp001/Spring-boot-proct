...
public class OrderStatusHistoryType {
    ...
    protected List<OrderStatusWithTypeType> previousStatuses;
     ...
     * 
     */
    public List<OrderStatusWithTypeType> getPreviousStatuses() {
        if (previousStatuses == null) {
            previousStatuses = new ArrayList<OrderStatusWithTypeType>();
        }
