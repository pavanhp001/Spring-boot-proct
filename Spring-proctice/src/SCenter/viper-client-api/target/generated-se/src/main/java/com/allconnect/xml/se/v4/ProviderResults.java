...
public class ProviderResults {
    ...
    protected List<ProductInfoType> productInfos;
     ...
     * This is why there is not a <CODE>set</CODE> method for the productInfos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProductInfos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ProductInfoType> getProductInfos() {
        if (productInfos == null) {
            productInfos = new ArrayList<ProductInfoType>();
        }
