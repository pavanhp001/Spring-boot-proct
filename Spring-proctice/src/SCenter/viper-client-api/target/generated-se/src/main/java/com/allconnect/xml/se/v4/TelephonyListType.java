...
public class TelephonyListType {
    ...
    protected List<TelephonyType> telephonies;

    /**
     * Gets the value of the telephonies property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the telephonies property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTelephonies().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TelephonyType> getTelephonies() {
        if (telephonies == null) {
            telephonies = new ArrayList<TelephonyType>();
        }
        return this.telephonies;
    }
