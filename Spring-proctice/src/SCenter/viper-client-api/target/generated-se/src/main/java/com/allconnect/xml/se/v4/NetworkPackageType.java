...
public class NetworkPackageType {
    ...
    @XmlElement(name = "networkProduct")
    protected List<NetworkProductType> networkProducts;
    ...
    /**
     * Gets the value of the networkProducts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the networkProducts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNetworkProducts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<NetworkProductType> getNetworkProducts() {
        if (networkProducts == null) {
            networkProducts = new ArrayList<NetworkProductType>();
        }
        return this.networkProducts;
    }
