 ...
 *       &lt;attGroup ref="{http://schemas.microsoft.com/intellisense/html-5}buttonServerAttributeGroup"/>
...
public class Button {
    ...
    @XmlAttribute(name = "CausesValidation")
    protected Boolean causesValidation;
    @XmlAttribute(name = "ValidationGroup")
    protected String validationGroup;
    @XmlAttribute(name = "OnServerClick")
    @XmlSchemaType(name = "anySimpleType")
    ...
    /**
     * Gets the value of the causesValidation property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public boolean isCausesValidation() {
    ...
    /**
     * Sets the value of the causesValidation property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
    ...
    /**
     * Gets the value of the onServerClick property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the onServerClick property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
