 ...
 *       &lt;attribute name="target" type="{http://schemas.microsoft.com/intellisense/html-5}browsingContext" />
 *       &lt;attribute name="ping" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *       &lt;attribute name="rel" type="{http://schemas.microsoft.com/intellisense/html-5}linkType" />
 *       &lt;attribute name="media" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *       &lt;attribute name="hreflang" type="{http://schemas.microsoft.com/intellisense/html-5}i18LanguageCode" />
 *       &lt;attribute name="type" type="{http://schemas.microsoft.com/intellisense/html-5}simpleContentType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class A {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "hgroup", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Hgroup.class),
        ...
        @XmlElementRef(name = "nav", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = JAXBElement.class),
        @XmlElementRef(name = "progress", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Progress.class),
        @XmlElementRef(name = "header", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "footer", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "dialog", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Dialog.class),
        ...
        @XmlElementRef(name = "menu", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Menu.class),
        @XmlElementRef(name = "pre", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Pre.class),
        @XmlElementRef(name = "figure", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Figure.class),
        ...
        @XmlElementRef(name = "style2", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Style2 .class),
        ...
        @XmlElementRef(name = "aside", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = JAXBElement.class),
        @XmlElementRef(name = "section", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = JAXBElement.class),
        @XmlElementRef(name = "q", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Q.class),
        @XmlElementRef(name = "article", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Article.class),
        ...
        @XmlElementRef(name = "details", namespace = "http://schemas.microsoft.com/intellisense/html-5", type = Details.class),
