 ...
 * generated in the com.A.html package. 
...
public class ObjectFactory {
    ...
    private final static QName _Address_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "address");
    private final static QName _Footer_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "footer");
    private final static QName _ProcessRequestResponse_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "processRequestResponse");
    private final static QName _ProcessRequest_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "processRequest");
    private final static QName _Aside_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "aside");
    private final static QName _Section_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "section");
    private final static QName _Header_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "header");
    private final static QName _Nav_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "nav");
    private final static QName _Caption_QNAME = new QName("http://schemas.microsoft.com/intellisense/html-5", "caption");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.A.html
     * 
     */
    ...
    /**
     * Create an instance of {@link SimpleFlowContentElement }
     * 
     */
    public SimpleFlowContentElement createSimpleFlowContentElement() {
        return new SimpleFlowContentElement();
    }
    ...
    /**
     * Create an instance of {@link SimplePhrasingContentElement }
     * 
     */
    public SimplePhrasingContentElement createSimplePhrasingContentElement() {
        return new SimplePhrasingContentElement();
    }
    ...
    /**
     * Create an instance of {@link Style1 }
     * 
     */
    public Style1 createStyle1() {
        return new Style1();
    }
    ...
    /**
     * Create an instance of {@link Style2 }
     * 
     */
    public Style2 createStyle2() {
        return new Style2();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SimpleFlowContentElement }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "address")
    public JAXBElement<SimpleFlowContentElement> createAddress(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Address_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "footer")
    public JAXBElement<SimpleFlowContentElement> createFooter(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Footer_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "processRequestResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "processRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "aside")
    public JAXBElement<SimpleFlowContentElement> createAside(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Aside_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "section")
    public JAXBElement<SimpleFlowContentElement> createSection(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Section_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "header")
    public JAXBElement<SimpleFlowContentElement> createHeader(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Header_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "nav")
    public JAXBElement<SimpleFlowContentElement> createNav(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Nav_QNAME, SimpleFlowContentElement.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/intellisense/html-5", name = "caption")
    public JAXBElement<SimpleFlowContentElement> createCaption(SimpleFlowContentElement value) {
        return new JAXBElement<SimpleFlowContentElement>(_Caption_QNAME, SimpleFlowContentElement.class, null, value);
    }
