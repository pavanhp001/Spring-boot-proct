 ...
 * generated in the com.A.xml.di.v4 package. 
...
public class ObjectFactory {
    ...
    private final static QName _DialogueEnterpriseResponse_QNAME = new QName("http://xml.A.com/v4", "dialogueEnterpriseResponse");
    ...
    private final static QName _DataFieldMatrix_QNAME = new QName("http://xml.A.com/v4", "dataFieldMatrix");
    ...
    private final static QName _DialogueEnterpriseRequest_QNAME = new QName("http://xml.A.com/v4", "dialogueEnterpriseRequest");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.A.xml.di.v4
     * 
     */
    ...
    /**
     * Create an instance of {@link DialogueListType }
     * 
     */
    public DialogueListType createDialogueListType() {
        return new DialogueListType();
    }
    ...
    /**
     * Create an instance of {@link DataFieldRefType }
     * 
     */
    public DataFieldRefType createDataFieldRefType() {
        return new DataFieldRefType();
    }
    ...
    /**
     * Create an instance of {@link DialogueTransactionTypeType }
     * 
     */
    public DialogueTransactionTypeType createDialogueTransactionTypeType() {
        return new DialogueTransactionTypeType();
    }
    ...
    /**
     * Create an instance of {@link DialogueType.DataGroupList }
     * 
     */
    public DialogueType.DataGroupList createDialogueTypeDataGroupList() {
        return new DialogueType.DataGroupList();
    }
    ...
    /**
     * Create an instance of {@link DataFieldDependencyType }
     * 
     */
    public DataFieldDependencyType createDataFieldDependencyType() {
        return new DataFieldDependencyType();
    }

    /**
     * Create an instance of {@link DataGroupType.DataFieldList }
     * 
     */
    public DataGroupType.DataFieldList createDataGroupTypeDataFieldList() {
        return new DataGroupType.DataFieldList();
    }
    ...
    /**
     * Create an instance of {@link DependentDataFieldsType }
     * 
     */
    public DependentDataFieldsType createDependentDataFieldsType() {
        return new DependentDataFieldsType();
    }
    ...
    /**
     * Create an instance of {@link DialogueRequestType }
     * 
     */
    public DialogueRequestType createDialogueRequestType() {
        return new DialogueRequestType();
    }

    /**
     * Create an instance of {@link DialogueResponseType }
     * 
     */
    public DialogueResponseType createDialogueResponseType() {
        return new DialogueResponseType();
    }
    ...
    /**
     * Create an instance of {@link DataFieldMatrixType }
     * 
     */
    public DataFieldMatrixType createDataFieldMatrixType() {
        return new DataFieldMatrixType();
    }
    ...
    /**
     * Create an instance of {@link DialogueResponseType.Results }
     * 
     */
    public DialogueResponseType.Results createDialogueResponseTypeResults() {
        return new DialogueResponseType.Results();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xml.A.com/v4", name = "dialogueEnterpriseResponse")
    public JAXBElement<EnterpriseResponseDocumentType> createDialogueEnterpriseResponse(EnterpriseResponseDocumentType value) {
        return new JAXBElement<EnterpriseResponseDocumentType>(_DialogueEnterpriseResponse_QNAME, EnterpriseResponseDocumentType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DataFieldMatrixType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://xml.A.com/v4", name = "dataFieldMatrix")
    public JAXBElement<DataFieldMatrixType> createDataFieldMatrix(DataFieldMatrixType value) {
        return new JAXBElement<DataFieldMatrixType>(_DataFieldMatrix_QNAME, DataFieldMatrixType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xml.A.com/v4", name = "dialogueEnterpriseRequest")
    public JAXBElement<EnterpriseRequestDocumentType> createDialogueEnterpriseRequest(EnterpriseRequestDocumentType value) {
        return new JAXBElement<EnterpriseRequestDocumentType>(_DialogueEnterpriseRequest_QNAME, EnterpriseRequestDocumentType.class, null, value);
    }
