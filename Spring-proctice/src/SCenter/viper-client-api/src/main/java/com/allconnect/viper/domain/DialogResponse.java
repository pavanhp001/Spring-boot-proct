...
import com.A.xml.di.v4.AbstractResponseType;
import com.A.xml.di.v4.DialogueListType;
    ...
    extends AbstractResponseType
{
	...
	public DialogResponse(final AbstractResponseType abstractResponseType) {

		if (abstractResponseType instanceof DialogueResponseType) {

			DialogueResponseType dialogueResponseType = (DialogueResponseType) abstractResponseType;
			this.setResults(dialogueResponseType.getResults());
		}
