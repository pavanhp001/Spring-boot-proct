...
public class CacheDecorator implements Runnable, Cache {
     ...
     * @param policies
     */
	public CacheDecorator(final ManagedCache _managedCache,
                          final CacheConfiguration _configuration,
                          final CacheMaintenancePolicy[] policies) {
        ...
        /*
		 * See:
		 * https://whirlycache.dev.java.net/issues/show_bug.cgi?id=7
         * TODO - once we support multiple policies, this needs to be removed.
         */
    ...
    /* (non-Javadoc)
     * @see com.whirlycott.cache.Cache#store(com.whirlycott.cache.Cacheable, java.lang.Object)
     */
    ...
    /* (non-Javadoc)
     * @see com.whirlycott.cache.Cache#store(com.whirlycott.cache.Cacheable, java.lang.Object, long)
     */
    ...
    /* (non-Javadoc)
     * @see com.whirlycott.cache.Cache#store(java.lang.Object, java.lang.Object, long)
     */
     ...
     * @param _key
     * @param _value
	 * @param _expiresAfter specified in milliseconds
     */
