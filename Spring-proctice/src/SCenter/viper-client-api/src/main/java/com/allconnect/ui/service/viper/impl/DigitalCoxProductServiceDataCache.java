...
public enum DigitalCoxProductServiceDataCache  {

	INSTANCE;

	private static final String PRODUCTS_CACHE = "web_cox_product_cache";
	...
	private static final Logger logger = Logger.getLogger(DigitalProductServiceDataCache.class);
