...
public interface Cache {
	...
	/**
	 * Retrieve an object whose key implements Cacheable.  The onRetrieve() method will 
	 * be executed here.
	 * @param key
	 ...
	 * The onStore() method will be executed here.
	 * @param key
	 * @param value
	 */
	...
	/**
	 * Store an object in the cache.
	 * @param key - the key to retrieve the object later.
	 * @param value - the object to be cached.
	 * @param expireTime - milliseconds that this item should be kept in the cache 
	 * (accurate to <code>tuner-sleeptime</code> seconds, as specified in <code>whirlycache.xml</code>.
	 */
	public void store(Object key, Object value, long expireTime);
	
	/**
	 * Store an object in the cache with a Cacheable key.  The onStore() method is 
	 * execute here.
	 * @param key - the key to retrieve the object later.
	 * @param value - the object to be cached.
	 * @param expireTime - milliseconds that this item should be kept in the cache 
