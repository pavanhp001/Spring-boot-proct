...
@XmlType(name = "salesContext", propOrder = {
    "orderSource",
    "entity"
})
public class SalesContext  {
    ...
    protected List<SalesContextEntityType> entity;
     ...
     * 
     */
    public List<SalesContextEntityType> getEntity() {
        if (entity == null) {
            entity = new ArrayList<SalesContextEntityType>();
        }
        return this.entity;
    }
