...
<html>
<head>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/css_new/main.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/css_new/jquery-ui.css"/>


<script src="<%=request.getContextPath()%>/js/jquDD5B.js'"></script>
<script src="<%=request.getContextPath()%>/js/jquery-ui.min.js"></script>
<script src="<%=request.getContextPath()%>/js/backbuttons.js"></script>

		<meta charset="utf-8">
		<title><fmt:message key="srt.title" /></title>
		<link rel="stylesheet" href="<%=request.getContextPath()%>/css/css_new/main.css" />
			...
			<article id="mainsection">
				...
				<section id="maincontent">
					<section id="logindialog">
						<form method="post" action="<%=request.getContextPath()%>/rest/login_process" name="loginProcess" style="height:265px;" id="login" class="loginWidget" autocomplete="off">
							<section class="logindialogcont">
								<div class="logindialogcontent">
									<div class="logintitle">Log in to SCORE!</div>
