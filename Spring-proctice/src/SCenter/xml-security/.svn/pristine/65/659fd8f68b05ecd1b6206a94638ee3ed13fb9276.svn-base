package com.allconnect.xmlsec.utility;
...
public final class VersionTracker
{
    ...
    private static final String REVISION_MINOR_NUM = "1";
    private static final String REVISION_PATCH_NUM = "001";
    private static final String REVISION_BUILD_NUM = "001";
