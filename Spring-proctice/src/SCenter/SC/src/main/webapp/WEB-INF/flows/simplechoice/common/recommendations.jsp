...
function displayChannelLineUpData(providerExternalId)
{
	//alert("providerExternalId="+providerExternalId);
	var urlPath = "<%=request.getContextPath()%>/salescenter/channelLineUpData?providerExternalId="+providerExternalId;
							...
							<div class="contentwrapper">
								...
								<input type="hidden" id="pageTitle" name="pageTitle" value="Recommendations">
									...
									<div class="SaversOffertbtns" align="center" style="width: 33%">
											<span>
												  <c:if test="${isUtilityOfferCompleted eq false}">
													  <input class="addtoorderbtn" type="button" id="UtiltyOffer" value="Utility Offer" onclick="goToUtilityOfferPage('backToUtilityOffer')"/>
												   </c:if>
										    </span>
										    ...
										    <span>
											     <c:if test="${isSaverOfferCompleted eq false}">
											        <input class="addtoorderbtn" type="button" id="goToOffer" value="Savers Offer" onclick="goToOfferPage('')"/>
										         </c:if>
										    </span>
									...
									<div class="rightbtns" style="width: 33%">
									     <span>
										    <input type="button" id="backToDiscoveryId" name="backToDiscoveryId" value="< Back" onclick="backToDiscovery('backToDiscoveryEvent');" style="float:right;"/>
										 </span>
									</div>
								</div>
							</div>
