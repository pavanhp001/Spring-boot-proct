...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/css_new/ordersummary.css'/>"/>
...
<script>
var isClosingOfferFlow = '${isClosingOfferFlow}';
...
var getClosingOfferFlagRes = function(data){
	if(data == "sessionTimeOut"){
		...
		if(data.responseText != "" && isClosingOfferFlow == ''){
  	...
  	<div id="concert_tool"><div id="concertHelp"><jsp:include page = "layout_hints.jsp"/></div></div>
		<div class="container">
			...
			<article id="mainsection">
				...
				<c:choose>
				<c:when test="${utilityOffer eq 'false'}">
