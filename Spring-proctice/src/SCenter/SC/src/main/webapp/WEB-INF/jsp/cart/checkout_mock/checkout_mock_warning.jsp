...
<form id="iframeForm" action="<%=request.getContextPath()%>/salescenter/CKO_mock_content"	method="post">
	...
	<div style="border:solid 2px #FFF4C8;;margin-top:10px;width:95%;">
		<textarea rows="20" cols="100" id="iFeedback" name="iFeedback" style="width:100%">{"CKO":{"orderId":2,"errorCode":100,"customerId":999,"status":"CKOWarning","lineItems":{"long":[1,2]},"params":{"string":{"page_id":"101","agent":"1234","provider":"6754","metrics":["1456_23","6_1"]}}}}</textarea>
	 </div>
	<input id="iData" name="iData" value='{"CKO":{"orderId":2,"errorCode":100,"customerId":999,"status":"CKOWarning","lineItems":{"long":[1,2]},"params":{"string":{"page_id":"101","agent":"1234","provider":"6754","metrics":["1456_23","6_1"]}}}}' type="hidden" />
