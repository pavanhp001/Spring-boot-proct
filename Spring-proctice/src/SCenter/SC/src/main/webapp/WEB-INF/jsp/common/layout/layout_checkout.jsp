...
--></nav>
    ...
    <div id="contentWrapper">
            <aside id="left_aside" style="width:250px">
            </aside>
...
<g>
	...
	<path fill="#FFFFFF" d="M23.861,18.677c0.116,0.435,0.177,0.891,0.177,1.362c0,2.921-2.367,5.289-5.288,5.289
		...
		c0.205,0.863-0.029,1.465-0.299,1.845L23.861,18.677z"/>
                ...
                <div class="content_border" style="width: 715px;">
	 ...
	 <tiles:insertAttribute name="main_content" />
                ...
                <c:if test="${utilityOffer eq 'false'}">
                	...
                	<span class="row">
	                	<span class="cell">
		                	<form action="<%=request.getContextPath()%>/rest/summary/${orderId}" method="post">
		                	<input type="hidden" id="pageTitle" name="pageTitle" value="Recommendations">
		                    <input type="submit" value="Cancel" class="cancel" title="Stop provisioning this product and return to Order Summary"/>
		                    </form>
	                    </span>
                    </span>
                </footer>
    ...
    <fmt:message key="layout.footer.message"/></span>
					<span class="cell">
                        ...
                        <input type="submit" name="endCall" value="<fmt:message key="layout.endCall"/>" class="css3button" /></input>
                        </form>
                     </span>
