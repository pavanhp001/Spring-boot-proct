		...
		if(confirmOrder){
			...
			if(auth != undefined){
				if(auth == "yes"){
					...
					savePageHtml(false, "");
					$("input#_eventId").val("orderSummaryViewEvent");
					return true;
				}
			}
			else{
...
<body onload="updateTimer();">
	<form method="POST"	action="${flowExecutionUrl}" name="orderSummaryRecap" onsubmit="return validateSubmit()">
		...
		<input type="hidden" id="_eventId" name="_eventId" value="closeCallSaleViewEvent">
							...
							<div class="contentwrapper">
								<section id="dialogue_wrapper">						   
									<section id="dialogue_content">
										<div style="overflow-x: hidden; width: 984px; overflow-y: auto; height: 165px;" id="content_new">
