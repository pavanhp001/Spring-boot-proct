		 ...
		 if($('#emailFlag').val() == 'Yes') {
			 ...
			 if (email != null && email != "" && emailReg.test(email)){
				//To save the html on page submit
				 ...
				 $.alert("Please enter valid Email", "Alert", 200, 340);
			 } 
	     }
		 else{
			//To save the html on page submit
										...
										<div class="pagecontainer" align="center">
											<div  id="emailTextBox" >
											   ...
											   <lable>Does customer want to receive link to AL website?</lable>&nbsp; &nbsp;&nbsp;
											    ...
											    <br>
											    <br><br>
												<input type="text" size="30px"id="bestEmail" name="bestEmail" value='<c:out value="${order.customerInformation.customer.bestEmailContact}" escapeXml="false" />' style="display:none"  ><br/>
											    <br/>
												</section>
