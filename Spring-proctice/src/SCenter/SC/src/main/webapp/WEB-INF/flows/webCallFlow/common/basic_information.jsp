...
.basicinfoformcontent .customerMoveDate{
	float:left;
}
.basicinfoformcontent .moveindatefield{
   /*  margin-top: 10px; */
}
...
#customerMove option { color:  black; }
...
var customerAddress = <%=request.getSession().getAttribute("customerAddress")%>;
...
if(customerAddress != null && customerAddress !="" ){
	 ...
	 $("#address1").val(customerAddress['street']);
	 $("#unitNumber").val(customerAddress['unitNumber']);
	 $("#zipcode").val(customerAddress['zipCode']);
	 zipCodeVal = customerAddress['zipCode'];
	 unitTypeVal = customerAddress['unitType'];
}
...
$("#moveInDateDivId").css("display","none");
		...
		if(isMoveInValue != '' &&  isMoveInValue == "Yes"){
			   ...
			   $('#customerMove').val(isMoveInValue);
...
*/
	    ...
	    */
		...
		$(unitTypeList).each(function(){
			...
			if(unitTypeVal != undefined && unitTypeVal != ""){
				selectedUnitType = unitTypeVal.trim();
			}
    	...
    	$("select#customerMove").bind("keyup change",function(){
      		var selectVal = $('#customerMove :selected').val();
    		if(selectVal == "") $(this).addClass("greyColor");
    	    else $(this).removeClass("greyColor");
      	...
      	$("select#customerMove").trigger("change");
      	if(moveinDateValue != ''){
            $("input[name=datepicker1]").val(moveinDateValue);
        }
      	if(zipCodeVal != undefined && zipCodeVal != ""){
    	  	$('input#zipcode').trigger("blur");
      	}
      	//Custom.init();
								...
								<c:when test="${rrContextId == '00'}">									
										<div class="pagecontainer" align="center">
											...
											<div class="basicinfoformcontent">
												...
												<div class ="filedsrow">
												   <div class="customerMoveDate">
												   <select id="customerMove" name="customerMove" >
												  ...
												  <div class="moveindatefield" id="moveInDateDivId">
														&nbsp;&nbsp;&nbsp;<input type="text" id="datepicker" maxlength="10" name="datepicker1" value="${salescontext.scMap['moveInDate']}" title="Move-In Date" placeholder="Move in Date" />
													</div>
												</div>
												<div class="fieldsrow">
<%-- 													<div class="moveindatefield" id="moveInDateDivId">
									...
									<div>
										<div>
										   <div style="margin-top: 296px">
											<div class="leftbtns" style="margin-left:215px; margin-top:20px">
