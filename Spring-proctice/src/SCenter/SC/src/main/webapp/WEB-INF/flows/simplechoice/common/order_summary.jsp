											...
											<!-- os header -->
												...
												<div class="os_productdata">
														...
														<!--CKO and AddToOrder-->
															...
															<c:if test="${statusAttribute != 'CKOComplete'}">
																<input id="${productExternalId}" class="os_buttons" value="<fmt:message key="orderSummary.beginOrder.button"/>"  type='button'  
																	onclick="CKO(${lineitem.lineItemExternalId}, ${providerId},'${lineItemProviderName}', '${productSource}','${flowExecutionUrl}');"
																	/>
														...
														<div class="os_itemnameinfo">
															...
															<c:if test="${liStatus != 'CANCELLED_REMOVED'}">
																<table cellpadding="0" cellspacing="0" class="os_itemdetailstbl">
																	...
																	<c:choose>
																		<c:when test="${productSource == 'REALTIME'}">
																			<tr class="os_id_row2">
													...
													<div class="os_statusdata">
														...
														<c:choose>
																<c:when test="${providerId == '27010360' || providerId == '15500201' || providerId == '24699452'}">
																	<c:if test="${statusAttribute != 'CKOComplete'}">
															...
															<c:if test="${statusAttribute != 'CKOComplete' && providerId != '27010360'}">
