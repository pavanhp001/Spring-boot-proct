...
<div id="wrapper">
	<header id="main_header">
    	<div id="SYP_toolbar">
		 ...
		 <div id="SYP_ALbar">
            <div class="row">
            <span class="cell rightpadding">Provider Name</span>
            <span class="cell rightpadding">1-800-000-0000</span>
            <span class="cell">Customer Full Name</span>
            <span class="cell rightpadding">123456789012345678901234567890</span>
            </div>
            </div>
	</header>
        	...
        	<section id="MiddleContentShell">
            	<nav id="products">
                	<ul class="productsNav">
                    	...
                    	<li class="prodcutsBtn">
                    		<a href="<%=request.getContextPath()%>/salescenter/recommendationsbyCategory/ASIS_PLAN" >
                    	...
                    	<li class="prodcutsBtn">
                    		<a href="<%=request.getContextPath()%>/salescenter/recommendationsbyCategory/WASTEREMOVAL" >
        		...
        		<table id="addLiGrid">
					<tr>
						...
						<td><tiles:insertAttribute name="summary_content" /></td>
					</tr>
				</table>
