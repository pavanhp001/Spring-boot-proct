	...
	$('input#Confirm_NonRR_4').val(email);
	 ...
	 if (email == "" || emailReg.test(email)){
		 if($("#sendEmail").is(":checked") && email == ""){
			 $.alert("Enter Valid Email.", "Alert", 200, 300);
			 return false;
		 }
										...
										<div class="pagecontainer" align="center">
											...
											<div  class="cofirmationformcontent">
												<div class="emailcontent" style="margin-left:0px; margin-top:80px;">
														Email:<input type="text" id="Confirm_NonRR_4" name="Confirm_NonRR_4" size="40" value='<c:out value="${order.customerInformation.customer.bestEmailContact}" escapeXml="false" />'><br/>
														<br/>
