...
<section id="contentfullcont">
	<header id="content_header">
		<div class="row">
			<span class="cell"> 
				<svg version="1.1" id="Layer_5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="29px"	height="29px" viewBox="0 0 29 29" enable-background="new 0 0 29 29"	xml:space="preserve" class="headphonesSVG">
				 	<g> <path fill="#96C43E" d="M29,25.298c0,2.066-1.677,3.744-3.744,3.744H4.411c-2.067,0-3.745-1.678-3.745-3.744V4.328 c0-2.068,1.678-3.745,3.745-3.745h20.845C27.323,0.583,29,2.26,29,4.328V25.298z" />
						<path fill="#FFFFFF"
			...
			<span class="cell pageTitle">Exception Page</span>
	...
	<section id="content">
		...
		<input type="hidden" id="pageTitle" name="pageTitle" value="Exception Page">
				...
				<div id="action_wrapper">
					<div class="widget_container">
						<div class="pagecontainer" align="center">
							<div class="cofirmationformcontent"></div>
						</div>
					</div>
				</div>
					...
					<div class="bottombuttons">
						<div class="rightbtns">
							<input type="submit" id="" name="" value="Forward >" />
						</div>
					</div>
				</div>
			...
			<input type="hidden" id="_eventId" name="_eventId" value="exceptionPageEvent">
		</form>
	</section>
</section>
