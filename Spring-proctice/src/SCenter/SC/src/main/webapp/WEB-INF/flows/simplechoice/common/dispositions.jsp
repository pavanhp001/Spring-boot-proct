        	...
        	<div class="widget_container">
        		<div class="dis_content">
        			<div class="dis_content_header">
        				<div class="dis_content_headtitle">No Opportunity</div>
             			<div class="dis_content_headtitle">Qualified</div>
        			</div>
        			<div class="dis_content_data">
        				<div class="dis_content_data_col">
          					<c:forEach items="${noOportunityDispositionList}" var="noOportunityDisp" varStatus="loopCounter">
          						<div class="dis_content_data_col_item">
									<span style="label">
										<input type="radio" id="noOportunityDisp${loopCounter.count}" value="${noOportunityDisp}"  class="radioDiv ">
									</span>
									<span style="value">
										<c:out escapeXml="false" value="${noOportunityDisp}" />
									</span>
          						</div>
							</c:forEach>
        				</div>
             			<div class="dis_content_data_col">
         					<c:forEach items="${qualifiedDidNotPurchaseDispositionList}" var="qualifiedDidNotPurchaseDisp" varStatus="loopCounter">
          						<div class="dis_content_data_col_item">
	         						<span style="label">
										<input type="radio"  id="qualifiedDidNotPurchaseDisp${loopCounter.count}" value="${qualifiedDidNotPurchaseDisp}"  class="radioDiv ">
									</span>
									<span style="value">
										<c:out escapeXml="false" value="${qualifiedDidNotPurchaseDisp}" />
									</span>
          						</div>
							</c:forEach>
             			</div>
