...
<script src="<c:url value='/script/html_save.js'/>"></script>
 ...
 function backToIdlePage(){
		var path =$("input#contextPath").val();
		window.location = path+"/salescenter/login_process";
}
 </script>
					...
					<section id="contentfullcont">
						<header id="content_header">
							<div class="row">
								...
								<span class="cell pageTitle">UnRecoverable Error Page</span>
								<span class="callTime" id="startTimeText"></span>
							</div>
						</header>
						<section id="content">
							<form id="error" name="error" action="<%=request.getContextPath()%>${url}" method="post" autocomplete="off">
							...
							<div class="pc_pdetails_cont">
									...
									<div class="bottombuttons">
											<div class="rightbtns">
												<input type="button" id="forward" name="" value="Forward >" onclick ="backToIdlePage()"/>
											</div>
									</div>
							</form>
						</section><!--  Content -->
