  ...
  <nav id="products">
                	<ul class="productsNav">
                        ...
                        <c:if test="${recIconMap.MIXEDBUNDLES != '#'}">
                    		...
                    		<a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=MIXEDBUNDLES" onclick="sendCategory('MIXEDBUNDLES')">
                        ...
                        <c:if test="${recIconMap.TRIPLE_PLAY != '#'}">
                        	<li class="prodcutsBtn">
	                    		<a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=TRIPLE_PLAY" onclick="sendCategory('TRIPLE_PLAY')">
                        ...
                        <c:if test="${recIconMap.TRIPLE_PLAY == '#'}">
	                  	...
	                  	<c:if test="${recIconMap.DOUBLE_PLAY != '#'}">
	                    	<li class="prodcutsBtn">
	                    		<a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=DOUBLE_PLAY" onclick="sendCategory('DOUBLE_PLAY')" >
								...
								<ul>
									<li><a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=DOUBLE_PLAY_VI">VIDEO-INTERNET</a></li>
									<li><a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=DOUBLE_PLAY_PV">PHONE-VIDEO</a></li>
									<li><a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=DOUBLE_PLAY_PI">PHONE-INTERNET</a></li>
								</ul>
	                        </li>
                        </c:if>
                        ...
                        <c:if test="${recIconMap.VIDEO != '#'}">
                    	    <li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=VIDEO"  onclick="sendCategory('VIDEO')">
                        ...
                        <c:if test="${recIconMap.INTERNET != '#'}">
                    	    <li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=INTERNET"  onclick="sendCategory('INTERNET')">
                        ...
                        <c:if test="${recIconMap.PHONE != '#'}">
                    	    <li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=PHONE" onclick="sendCategory('PHONE')">
                    	...
                    	<li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=HOMESECURITY" onclick="sendCategory('HOMESECURITY')">
                        ...
                        <c:if test="${recIconMap.ASIS_PLAN != '#'}">
                    	    <li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=ASIS_PLAN" onclick="sendCategory('ASIS_PLAN')">
                        ...
                        <c:if test="${recIconMap.ASIS_PLAN == '#'}">
                         ...
                         <c:if test="${recIconMap.ELECTRICITY != '#'}">
                    	    <li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=ELECTRICITY" onclick="sendCategory('ELECTRICITY')">
                    	...
                    	<li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=NATURALGAS" onclick="sendCategory('NATURALGAS')">
                    	...
                    	<li class="prodcutsBtn">
                    	    <a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=WATER" onclick="sendCategory('WATER')">
                        ...
                        <c:if test="${recIconMap.WASTEREMOVAL != '#'}">
                    		...
                    		<a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=WASTEREMOVAL" onclick="sendCategory('WASTEREMOVAL')">
                        ...
                        <c:if test="${recIconMap.WASTEREMOVAL == '#'}">
                         ...
                         <c:if test="${recIconMap.APPLIANCEPROTECTION != '#'}">
                    	    <li class="prodcutsBtn2">
                    		<a href="${flowExecutionUrl}&_eventId=recommendationsEvent&CategoryName=APPLIANCEPROTECTION" onclick="sendCategory('APPLIANCEPROTECTION')">
