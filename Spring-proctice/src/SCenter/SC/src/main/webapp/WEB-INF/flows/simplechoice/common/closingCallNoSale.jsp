...
function validateEmail(){
	...
	else
	{
		...
		if($('#CloseCallNoSale_Webflow_1').length!=0)
		{
			if($('#CloseCallNoSale_Webflow_Email').val()==""){
				$('#CloseCallNoSale_Webflow_1').after('<span class="missingFields">*</span>');
...
$("#CloseCallNoSale_Webflow_1").live("change", function(){
