											...
											<div class="basicinfoformcontent">
												<div class="fieldsrow">
													...
													<div class="middlenmfield">
														<input id="middleName" name="middleName" type="text" class="text" value='<c:out value="${salescontext.scMap['consumer.name.middle']}" escapeXml="false"/>' onchange="capitalizeText(this);"  title="MI" size="2"  maxlength="1"  placeholder="MI" />
													</div>
												...
												<div class="fieldsrow">
													<div class="addressfield">
														<input id="address1" name="address1" type="text" class="text addressfield" value='<c:out value="${salescontext.scMap['address.street1']}" escapeXml="false"/>' onchange="capitalizeText(this);"  maxlength="100" title="Address 1"  placeholder="Address 1"/>
													</div>
												</div><!-- Row -->
												<div class="fieldsrow">
													...
													<div class="unitnofield">
														<input id="unitNumber" name="unitNumber" type="text" class="text" value='<c:out value="${salescontext.scMap['unit.number']}" escapeXml="false"/>' title="Unit Number" size="10" placeholder="Unit Number" />
													</div>
												</div><!-- Row -->
												<div class="fieldsrow">
													<div class="cityfield">
														<input id="city" name="city" type="text" class="text" value='<c:out value="${salescontext.scMap['address.city']}" escapeXml="false"/>' onchange="capitalizeText(this);" maxlength="100" title="City"   placeholder="City"/>
													</div>
													...
													<div class="zipfield">
														<input id="zipcode" name="zipcode" type="text" class="text" value='<c:out value="${salescontext.scMap['address.zip']}" escapeXml="false"/>' maxlength="10" title="Zip Code" placeholder="Zip Code" />
													</div>
												...
												<div class="fieldsrow">
													<div class="moveindatefield" id="moveInDateDivId">
														<input type="text" id="datepicker" maxlength="10" name="datepicker1" value='<c:out value="${dob}" escapeXml="false"/>'  title="Move-In Date" placeholder="Move in Date" />
													</div>
													<c:if test="${HideElectricDate eq 'false'}">
														<div class="electricdtfield">
															<input type="text" id="datepickerElectric" class="text" maxlength="10" name="datepicker2" value='<c:out value="${customerVO.dtRequestedStartDate}" escapeXml="false"/>'
																title="Electric Start Date" placeholder="Electric Start Date"/>
															<input type="hidden" id="datepicker2" class="text" size="12" maxlength="10" name="datepicker2"	value='<c:out value="${customerVO.dtRequestedStartDate}" escapeXml="false"/>'
																title="Electric Start Date" style="margin-right:3px;" />
														</div>
													</c:if>
													<c:if test="${HideGasDate eq 'false'}">
														<div class="gasdatefield">
															<input type="text" id="datepickerGas" class="text" size="12" maxlength="10" name="datepicker3" value='<c:out value="${customerVO.dtGasRequestedStartDate}" escapeXml="false"/>' 
																title="Gas Start Date" placeholder="Gas Start Date"/>
															<input type="hidden" id="datepicker3" class="text" size="12" maxlength="10" name="datepicker3" value='<c:out value="${customerVO.dtGasRequestedStartDate}" escapeXml="false"/>' 
