...
function validateEmail(){
	var email = $.trim($('input#Confirm_NonRR_4').val());
...
.cofirmationformcontent input[type="text"] {
    ...
    padding: 2px;
					...
					<section id="contentfullcont">
						...
						<section id="content">
							<form id="confirmation" name="confirmation" action="<%=request.getContextPath()%>/salescenter/offer" method="post" autocomplete="off">
