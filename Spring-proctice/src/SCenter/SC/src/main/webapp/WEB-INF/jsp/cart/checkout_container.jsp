...
function updateIframeSrc()
{
 ...
 var data = '{"CKO":{"customerId":'+customerId+',"orderId":'+orderId+',"parentUrl":"'+parentUrl+'","status":"CKOReady","lineItems":{"long":['+lineitemId+']},"params":{"string":["certificate='+key+'","page_id=101","provider_id='+providerId+'"]}}}';
