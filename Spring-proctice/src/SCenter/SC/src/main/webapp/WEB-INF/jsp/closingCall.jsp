...
function showEmail() {
	   $("#emailFlag").val('emailYes');
	   $("#bestEmail").show();
} 
function hideEmail()	{
	   $("#emailFlag").val('emailNo');
	   $("#bestEmail").hide();
}
...
<section id="contentfullcont">
					...
					<section id="content">
						<form id="closingcall" name="closingcall" action="<%=request.getContextPath()%>/salescenter/dispositions" method="post">
