...
<script src="<c:url value='/script/basic_information_usaa.js'/>"></script>
								...
								<c:when test="${rrContextId == '00'}">											
										<div class="pagecontainer" align="center">
											...
											<div class="basicinfoformcontent">
												...
												<div class ="filedsrow">
												<div class="unitnofield">
												   <input id="usaaId" name="usaaId" type="text" class="text" title="USAA" size="20" placeholder="USAA Member ID" />
												  </div>
												</div>
												<div class ="filedsrow">
