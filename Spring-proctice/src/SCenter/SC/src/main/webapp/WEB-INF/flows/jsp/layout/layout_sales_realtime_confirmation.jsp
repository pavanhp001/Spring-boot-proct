...
<%-- 			<div class="concertlogo">
			...
			<footer id="main_footer">
				<div class="footer_center">
					<div class="endcall">
						<form name="endCallFormId" id="endCallFormId" action="${flowExecutionUrl}" method="post">
							...
							<c:if test="${!isClosingCall}">
			                        <input type="button" id="endCallButton" name="endCallButton"  onclick="confirmEndCall();" value="<fmt:message key="layout.endCall"/>" class="endcallbtn"/>
			           		</c:if>
						</form>
					</div>
