...
public class GetOrderByLineItemTestF {
	...
	public void testRead() {
		String inputXml1 = BaseALTestX
				.getXMLFromFile("src\\test\\resources\\xml\\GetOrderByLineItem.xml");
	...
	public void doTask(
		...
		TaskGetOrderByLineItem task = (TaskGetOrderByLineItem) SpringUtilTest
				.getBean(TaskGetOrderByLineItem.class);
