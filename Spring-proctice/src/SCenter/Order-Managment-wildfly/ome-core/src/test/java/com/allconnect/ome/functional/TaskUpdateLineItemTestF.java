...
public final class TaskUpdateLineItemTestF {
	...
	public void testUpdateLineItem() {
		...
		String inputXml1 = BaseALTest.getXMLFromFile("src\\test\\resources\\xml\\93463.xml");
	...
	public void doTask(
		...
		LineItemCollectionType coll = request.getUpdatedLineItemInfo();
		List<LineItemType> lineItemTypeList = coll.getLineItemList();
		assertNotNull(lineItemTypeList);

		TaskUpdateLineItem task = (TaskUpdateLineItem) SpringUtilTest
				.getBean(TaskUpdateLineItem.class);
		// TaskUpdateLineItem task = new TaskUpdateLineItem();
