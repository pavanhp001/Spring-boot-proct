...
import com.AL.ie.task.LocalTaskGetProductCatalog;
...
@Component("taskGetProductCatalog")
public class TaskGetProductCatalog extends IeTaskBase<OrderManagementRequestResponseDocument>   
implements LocalTaskGetProductCatalog<OrderManagementRequestResponseDocument> 
{
 
    private Logger logger  = Logger.getLogger( TaskGetProductCatalog.class );
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:get Product Catalog");
	}
