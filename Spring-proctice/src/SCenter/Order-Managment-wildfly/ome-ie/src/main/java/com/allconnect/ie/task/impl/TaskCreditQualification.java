...
import com.AL.ie.task.LocalTaskCreditQualification;
...
@Component("taskCreditQualification")
public class TaskCreditQualification extends IeTaskBase<OrderManagementRequestResponseDocument>   
implements LocalTaskCreditQualification<OrderManagementRequestResponseDocument> 
{
 
    private Logger logger  = Logger.getLogger( TaskCreditQualification.class );
	...
	public OrderManagementRequestResponseDocument processResponse(
		...
		logger.debug("TaskCreditQualification processResponse: " + doc.toString());
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:Credit Qualification");
	}
