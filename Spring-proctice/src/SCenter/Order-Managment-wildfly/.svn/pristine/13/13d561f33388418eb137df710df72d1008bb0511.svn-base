...
import com.AL.ie.task.LocalTaskOrderStatus;
...
@Component("taskOrderStatus")
public class TaskOrderStatus extends IeTaskBase<OrderManagementRequestResponseDocument>   
implements LocalTaskOrderStatus<OrderManagementRequestResponseDocument> 
{
 
    private Logger logger  = Logger.getLogger( TaskOrderStatus.class );
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:Order Status");
	}
