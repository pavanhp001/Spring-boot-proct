...
@Component("taskOrderDateQualification")
public class TaskOrderDateQualification extends IeTaskBase<OrderManagementRequestResponseDocument>   
implements LocalTaskCreditQualification<OrderManagementRequestResponseDocument> 
{
 
    private Logger logger  = Logger.getLogger( TaskOrderDateQualification.class );
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:Order Date Qualification");
	}
