...
@Component("taskServiceQualification")
public class TaskServiceQualification extends IeTaskBase<OrderManagementRequestResponseDocument>   
implements LocalTaskCreditQualification<OrderManagementRequestResponseDocument> 
{
 
    private Logger logger  = Logger.getLogger( TaskServiceQualification.class );
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:Service Qualification");
	}
