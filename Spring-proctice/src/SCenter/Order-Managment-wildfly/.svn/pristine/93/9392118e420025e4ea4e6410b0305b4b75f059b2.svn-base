...
import com.AL.ie.task.LocalTaskUpdateOrder;
...
@Component("taskIeUpdateOrder")
public class TaskIeUpdateOrder extends
		IeTaskBase<OrderManagementRequestResponseDocument> implements
		LocalTaskUpdateOrder<OrderManagementRequestResponseDocument> {

	private Logger logger = Logger.getLogger(TaskIeUpdateOrder.class);
	...
	public void broadcast(final String objectToBroadcast) {
		logger.debug("broadcast override:Update Order");
	}
