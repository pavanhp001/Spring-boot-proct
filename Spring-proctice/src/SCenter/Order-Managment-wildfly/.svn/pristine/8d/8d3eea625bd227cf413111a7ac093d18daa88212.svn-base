...
public class GetOrderScheduledDateTestF {
	...
	public void doTask(
		...
		TaskGetOrderByScheduleDate task = (TaskGetOrderByScheduleDate) SpringUtilTest
				.getBean(TaskGetOrderByScheduleDate.class);
