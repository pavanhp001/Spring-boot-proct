...
public enum CartDialogueFactory {
	
	INSTANCE;
	
	private static final Logger logger = Logger.getLogger(CartDialogueFactory.class);
	/**
	 * @param context
	 * @return
	...
	/*
	 //HF
	public DialogueResponseType getDialoguesByContextCloseCall( Map<String, Map<String, String>> dataMap) throws BaseException 
	{
		StopWatch timer=new StopWatch();
		timer.start();
		DialogueResponseType dialogResponse = null;
