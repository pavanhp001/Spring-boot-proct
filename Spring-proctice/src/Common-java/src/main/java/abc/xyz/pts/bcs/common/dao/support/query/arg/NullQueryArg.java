...
/**
 *    Simple arg object to check field IS NULL
 */
public class NullQueryArg extends QueryArg {
     ...
     */
    public NullQueryArg(final Field searchField, final Table table) {

        addToWhereClause(table.getValue() + "." + searchField + " IS NULL");
