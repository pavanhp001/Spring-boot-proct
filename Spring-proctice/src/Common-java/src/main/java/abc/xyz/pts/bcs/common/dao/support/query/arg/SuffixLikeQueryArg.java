 ...
 *
 */
public class SuffixLikeQueryArg extends QueryArg {
     ...
     */
    public SuffixLikeQueryArg(final Field searchField, final Table table, Object value) {

        if (value != null && !"".equals(value)) {
            value = value + WILDCARD;
            addToWhereClause(table.getValue() + "." + searchField + " LIKE ? ");
