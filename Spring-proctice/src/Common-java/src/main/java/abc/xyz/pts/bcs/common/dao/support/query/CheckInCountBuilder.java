 ...
 * 
 */
public class CheckInCountBuilder extends CountBuilder {

    public CheckInCountBuilder(final TableActionCommand tableCommand) {
        super(tableCommand);
    }

    public String getQueryForCountSql() {
        final StringBuilder sql = new StringBuilder(526);
        sql.append("SELECT count(0) FROM ( SELECT /*+ FIRST_ROWS(1) */null FROM ");
